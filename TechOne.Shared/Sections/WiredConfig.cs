...
{
    public class WiredConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://feeds.wired.com/wired/index")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("WiredListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("WiredDetailPage", true);
                    }
                };
            }
        }
