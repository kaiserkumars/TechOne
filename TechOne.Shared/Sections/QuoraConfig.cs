...
{
    public class QuoraConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("https://www.quora.com/rss")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("QuoraListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("QuoraDetailPage", true);
                    }
                };
            }
        }
