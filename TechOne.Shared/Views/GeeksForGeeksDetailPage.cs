...
{
    public sealed partial class GeeksForGeeksDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public GeeksForGeeksDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new GeeksForGeeksConfig());
