...
{
    public sealed partial class HackerRankDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public HackerRankDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new HackerRankConfig());
