...
{
    public sealed partial class CodeChefDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public CodeChefDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new CodeChefConfig());
