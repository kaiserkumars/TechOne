...
{
    public sealed partial class HackerEarthDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public HackerEarthDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new HackerEarthConfig());
