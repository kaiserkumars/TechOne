...
{
    public sealed partial class TechCrunchDetailPage : PageBase
    {
        private DataTransferManager _dataTransferManager;
        public DetailViewModel<RssDataConfig, RssSchema> ViewModel { get; set; }

        public TechCrunchDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new TechCrunchConfig());
